 ...
 */
public class QFMInternalMessagesDTO extends QFMMailBaseDTO {
  ...
  private List<QFMInternalAttachmentDTO> attachments;
  ...
  public List<QFMInternalAttachmentDTO> getAttachments() {
    return attachments;
  }

  public void setAttachments(List<QFMInternalAttachmentDTO> attachments) {
