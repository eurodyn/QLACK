...
/**
 * DTO for QFMEmail data.
 */
public class QFMEmailDTO implements Serializable {
  ...
  private List<QFMAttachmentDTO> attachments;
  ...
  public List<QFMAttachmentDTO> getAttachments() {
    return attachments;
  }

  public void setAttachments(List<QFMAttachmentDTO> attachment) {
    this.attachments = attachment;
  }

  public void addAttachment(QFMAttachmentDTO attachmentDTO) {
    if (attachments == null) {
