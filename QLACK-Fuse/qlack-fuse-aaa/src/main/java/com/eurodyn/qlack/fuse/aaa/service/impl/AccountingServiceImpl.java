...
public class AccountingServiceImpl implements AccountingService {
    ...
    // JUL reference.
    private static final Logger LOGGER = Logger.getLogger(com.eurodyn.qlack.fuse.aaa.service.AccountingService.class.getName());
    ...
    @Autowired
    public AccountingServiceImpl(SessionRepository sessionRepository,
    ...
    public Set<String> getSessionIDsForAttribute(
