...
@Validated
public class QFFIFileUploadResource {

  // Logger.
  private static final Logger LOGGER = Logger.getLogger(QFFIFileUploadResource.class.getName());

  // Service references.
  private QFFIFileUploadService qffiFileUploadService;

  @Autowired
  public QFFIFileUploadResource(
      QFFIFileUploadService qffiFileUploadService) {
    this.qffiFileUploadService = qffiFileUploadService;
  }
...
//  }
  ...
  public ResponseEntity checkChunk(
    ...
    QFFICheckChunkRequest req = new QFFICheckChunkRequest();
    req.setChunkNumber(chunkNumber);
    req.setFileAlias(alias);
    QFFICheckChunkResponse res = qffiFileUploadService.checkChunk(req);
...
//
//    try {
//      QFFIFileUploadRequest fur = new QFFIFileUploadRequest();
