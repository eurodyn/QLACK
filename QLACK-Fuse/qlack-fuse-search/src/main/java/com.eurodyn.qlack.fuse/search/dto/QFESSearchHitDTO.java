...
/**
 * Represents a specific hit within a set of hits held by {@link QFESSearchResultDTO}. 23/01/2018 The
 * Adding the innerHits for the nested Objects in the Search Hit DTO
 */
public class QFESSearchHitDTO {
  ...
  public String toString() {
    return "QFESSearchHitDTO [source=" + source + ", score=" + score + ", type=" + type
        + ", innerHits=" + innerHits + "]";
  }
