 ...
 * ES.
 */
public class QFESESDocumentIdentifierDTO implements Serializable {
  ...
  public QFESESDocumentIdentifierDTO() {
    super();
  }

  public QFESESDocumentIdentifierDTO(String index, String type, String id) {
    this(index, type, id, false);
  }

  public QFESESDocumentIdentifierDTO(String index, String type, String id, boolean refresh) {
    super();
    this.index = index;
    this.type = type;
    this.id = id;
