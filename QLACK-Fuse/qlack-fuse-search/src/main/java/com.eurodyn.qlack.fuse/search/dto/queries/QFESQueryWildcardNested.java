 ...
 * wildcard-query.html
 */
public class QFESQueryWildcardNested extends QFESQuerySpec {
  ...
  public QFESQueryWildcardNested setTerm(String field, String wildcard, String path,
